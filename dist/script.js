...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_sliders__WEBPACK_IMPORTED_MODULE_1__["default"])('.main-slider-item', 'horizontal');
...
var drop = function drop() {
  var fileInputs = document.querySelectorAll('[name="upload"]'); //dragenter - object above the dropArea
...
var filter = function filter() {
  ...
  var addClick = function addClick(btn) {
    var markType = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
    btn.addEventListener('click', function () {
      typeFilter(markType);
    });
  };
...
var forms = function forms() {
  ...
  upload.forEach(function (item) {
    //show shorted name of file for users
...
var modals = function modals() {
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        document.body.style.marginRight = "".concat(scroll, "px"); //add false scroll
      });
    });
  ...
  function openByScroll(selector) {
    window.addEventListener('scroll', function () {
      var scrollHeight = Math.max(document.documentElement.scrollHeight, document.body.scrollHeight); //for two mods
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return regeneratorRuntime.awrap(Object(_services_requests__WEBPACK_IMPORTED_MODULE_6__["getResource"])('http://localhost:3000/styles').then(function (res) {
